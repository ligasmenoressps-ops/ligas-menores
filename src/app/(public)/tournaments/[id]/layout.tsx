      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6 border-b border-gray-100 mb-2">
            <Link 
              href={`/categoria/${tournament.category.name.toLowerCase()}`} 
              className="text-sm font-bold text-blue-600 hover:text-blue-800 mb-4 inline-flex items-center"
            >
              &larr; Volver a Categoría {tournament.category.name}
            </Link>
